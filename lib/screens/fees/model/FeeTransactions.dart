class FeesTranscation {
  ...
  factory FeesTranscation.fromJson(Map<String, dynamic> json) =>
      FeesTranscation(
        date: json["date"],
        paymentMethod: json["payment_method"] ?? '',
        changeMethod: json["change_method"] ?? '',
        paidAmount: json["paid_amount"].runtimeType == int
            ? json["paid_amount"]
            : int.tryParse(json["paid_amount"]),
        waiver: json["waiver"].runtimeType == int
            ? json["waiver"]
            : int.tryParse(json["waiver"]),
        fine: json["fine"].runtimeType == int
            ? json["fine"]
