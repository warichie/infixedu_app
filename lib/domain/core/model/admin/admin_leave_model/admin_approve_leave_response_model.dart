class AdminApproveLeaveResponseModel {
  bool? success;
  List<ApproveLeaveData>? data;
  String? message;

  AdminApproveLeaveResponseModel({this.success, this.data, this.message});

  AdminApproveLeaveResponseModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    if (json['data'] != null) {
      data = <ApproveLeaveData>[];
      json['data'].forEach((v) {
        data!.add(ApproveLeaveData.fromJson(v));
      });
    }
