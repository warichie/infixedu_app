class StudentDocumentsResponseModel {
  ...
  StudentDocumentsResponseModel.fromJson(Map<String, dynamic> json) {
    ...
    data = json['data'] != null ? DocumentsList.fromJson(json['data']) : null;
...
class DocumentsList {
  ...
  ProfileDocumentsPermissions? showPermission;

  DocumentsList({this.profileDocuments, this.showPermission});
  ...
  DocumentsList.fromJson(Map<String, dynamic> json) {
    ...
    showPermission = json['show_permission'] != null
        ? ProfileDocumentsPermissions.fromJson(json['show_permission'])
        : null;
  }
...
class ProfileDocumentsPermissions {
  int? session;
  int? studentClass;
  int? section;
  int? rollNumber;
  ...
  ProfileDocumentsPermissions.fromJson(Map<String, dynamic> json) {
